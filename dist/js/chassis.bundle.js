...
class Drawer extends DialogBase {
  ...
  _initSwipe() {
    ...
    if (element.classList.contains('drawer-bottom')) {
      ...
      swipeConfig[isRTL$1() ? 'leftCallback' : 'rightCallback'] = () => this.hide();
    } else {
      // drawer-start (default)
      swipeConfig[isRTL$1() ? 'rightCallback' : 'leftCallback'] = () => this.hide();
    }
