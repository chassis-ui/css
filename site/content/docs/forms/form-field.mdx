...
<Example code={`<fieldset class="form-field">
    ...
    <div class="form-check">
      ...
      <div class="form-help font-sm" id="fieldDescription1Help">$9/month — For individuals.</div>
    </div>
    <div class="form-check">
      ...
      <div class="form-help font-sm" id="fieldDescription2Help">$29/month — For teams.</div>
    </div>
    <div class="form-help">
...
<Example code={`<fieldset class="form-field">
    <legend class="form-label">Select a plan</legend>
      <div class="form-check form-card">
        ...
        <div class="form-help font-sm" id="fieldCard1Help">$9/month — For individuals.</div>
      </div>
      <div class="form-check form-card">
        ...
        <div class="form-help font-sm" id="fieldCard2Help">$29/month — For teams.</div>
    </div>
  </fieldset>`} />
