...
<Example code={`<div class="row gap-xl">
    <form class="col context p-md" data-cx-theme="light">
      <div class="mb-md">
    ...
    <form class="col context p-md" data-cx-theme="dark">
      <div class="mb-md">
