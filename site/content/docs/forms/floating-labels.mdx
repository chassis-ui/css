...
<Callout type="warning" title="Sizing">
  `.form-floating` does not respond to the `.sm` and `.lg` size modifiers. Floating inputs always render at the fixed height defined by `$form-floating-height`.
</Callout>
...
<Example class="vstack gap-md" code={`<div class="form-floating">
