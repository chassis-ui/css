...
Breakpoint-prefixed column classes control span width at specific viewport widths. The example below uses two `.g-col-6` columns at all viewports, then narrows to three `.md:g-col-4` columns at the `md` breakpoint and above:
