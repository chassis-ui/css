...
| `$enable-bts`                     | `true` (default) or `false`        | Enables [Breakpoint Type Scale]([[docsref:/content/typography#breakpoint-type-scale]]) utility classes for responsive typography based on breakpoints. |
