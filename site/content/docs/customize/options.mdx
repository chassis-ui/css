...
| `$enable-adaptive-font-sizes`     | `true` (default) or `false`        | Enables [Breakpoint Type Scale]([[docsref:/content/typography#breakpoint-type-scale]]) utility classes for adaptive typography based on breakpoints. |
