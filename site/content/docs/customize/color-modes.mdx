...
Tailwind CSS projects using [the Tailwind entry point]([[docsref:/getting-started/tailwind]]) get `dark:` and `light:` variants that follow this same nearest-attribute-wins logic automatically, on every utility — not just the ones covered here.
...
<Example class="d-flex justify-content-between" code={`<div class="dropdown" data-cx-theme="light">
    <button class="button secondary caret" type="button" id="dropdownMenuButtonLight" data-cx-toggle="menu" aria-expanded="false">
      Default dropdown
    </button>
  ...
  <div class="dropdown" data-cx-theme="dark">
    <button class="button secondary caret" type="button" id="dropdownMenuButtonDark" data-cx-toggle="menu" aria-expanded="false">
      Dark dropdown
    </button>
...
<Example showMarkup={false} code={`<div class="cxd-example fg-main bg-main" data-cx-theme="primary">
  ...
  <div class="dropdown">
    <button class="button secondary caret" type="button" id="dropdownMenuButtonCustom" data-cx-toggle="menu" aria-expanded="false">
      Dropdown button
    </button>
