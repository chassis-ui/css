...
Chassis uses **oklch** as its default color space. For a full overview of how the color system works — including design tokens, CSS custom properties, and palette maps — see [Color System]([[docsref:/core-concepts/color-system]]) and [Design Tokens]([[docsref:/core-concepts/design-tokens]]).
