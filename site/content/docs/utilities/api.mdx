...
.bg-primary {
  --cx-bg-opacity: 1;
  background-color: oklch(from var(--cx-primary) l c h / var(--cx-bg-opacity)) !important;
}
```
...
@media (min-width: 576px) {
  .small:opacity-0 { opacity: 0 !important; }
  .small:opacity-25 { opacity: .25 !important; }
  .small:opacity-50 { opacity: .5 !important; }
  .small:opacity-75 { opacity: .75 !important; }
  .small:opacity-100 { opacity: 1 !important; }
}

@media (min-width: 768px) {
  .medium:opacity-0 { opacity: 0 !important; }
  .medium:opacity-25 { opacity: .25 !important; }
  .medium:opacity-50 { opacity: .5 !important; }
  .medium:opacity-75 { opacity: .75 !important; }
  .medium:opacity-100 { opacity: 1 !important; }
}

@media (min-width: 992px) {
  .large:opacity-0 { opacity: 0 !important; }
  .large:opacity-25 { opacity: .25 !important; }
  .large:opacity-50 { opacity: .5 !important; }
  .large:opacity-75 { opacity: .75 !important; }
  .large:opacity-100 { opacity: 1 !important; }
}

@media (min-width: 1200px) {
  .xlarge:opacity-0 { opacity: 0 !important; }
  .xlarge:opacity-25 { opacity: .25 !important; }
  .xlarge:opacity-50 { opacity: .5 !important; }
  .xlarge:opacity-75 { opacity: .75 !important; }
  .xlarge:opacity-100 { opacity: 1 !important; }
}

@media (min-width: 1400px) {
  .2xlarge:opacity-0 { opacity: 0 !important; }
  .2xlarge:opacity-25 { opacity: .25 !important; }
  .2xlarge:opacity-50 { opacity: .5 !important; }
  .2xlarge:opacity-75 { opacity: .75 !important; }
  .2xlarge:opacity-100 { opacity: 1 !important; }
}
```
