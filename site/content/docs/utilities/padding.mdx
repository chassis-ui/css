...
<Example class="cxd-example-spacing vstack gap-md" code={`<div class="p-xs">p-xs</div>
...
<Example class="cxd-example-spacing vstack gap-md" code={`<div class="px-lg py-xs">px-lg, py-xs</div>
  <div class="px-xs py-lg">px-xs, py-lg</div>`} />

## Individual edges

Single-edge utilities set padding on one edge without affecting the others.

<Example class="cxd-example-spacing vstack gap-md" code={`<div class="pt-lg">pt-lg</div>
  <div class="pb-lg">pb-lg</div>
  <div class="ps-lg">ps-lg</div>
  <div class="pe-lg text-end">pe-lg</div>`} />

## Responsive padding

Prefix any padding class with a breakpoint to apply it at that breakpoint and above. Unprefixed classes apply from `xs` up.

<Example class="cxd-example-spacing vstack gap-md" code={`<div class="p-xs md:p-lg">p-xs, then p-lg from md up</div>`} />
