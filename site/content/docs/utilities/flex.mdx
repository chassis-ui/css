...
<Example class="cxd-example-flex" code={`<div class="d-flex p-xs">I'm a flexbox container!</div>`} />

<Example class="cxd-example-flex" code={`<div class="d-inline-flex p-xs">I'm an inline flexbox container!</div>`} />
...
<Example class="cxd-example-flex" code={`<div class="d-flex flex-row mb-md">
...
<Example class="cxd-example-flex" code={`<div class="d-flex flex-column mb-md">
    <div class="p-xs">Flex item 1</div>
    <div class="p-xs">Flex item 2</div>
    <div class="p-xs">Flex item 3</div>
  </div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex justify-content-start mb-md">
    <div class="p-xs cxd-highlight">Justify</div>
    <div class="p-xs cxd-highlight">Content</div>
    <div class="p-xs cxd-highlight">Start</div>
  </div>
  <div class="d-flex justify-content-end mb-md">
    <div class="p-xs cxd-highlight">Justify</div>
    <div class="p-xs cxd-highlight">Content</div>
    <div class="p-xs cxd-highlight">End</div>
  </div>
  <div class="d-flex justify-content-center mb-md">
    <div class="p-xs cxd-highlight">Justify</div>
    <div class="p-xs cxd-highlight">Content</div>
    <div class="p-xs cxd-highlight">Center</div>
  </div>
  <div class="d-flex justify-content-between mb-md">
    <div class="p-xs cxd-highlight">Justify</div>
    <div class="p-xs cxd-highlight">Content</div>
    <div class="p-xs cxd-highlight">Between</div>
  </div>
  <div class="d-flex justify-content-around mb-md">
    <div class="p-xs cxd-highlight">Justify</div>
    <div class="p-xs cxd-highlight">Content</div>
    <div class="p-xs cxd-highlight">Around</div>
  </div>
  <div class="d-flex justify-content-evenly">
    <div class="p-xs cxd-highlight">Justify</div>
    <div class="p-xs cxd-highlight">Content</div>
    <div class="p-xs cxd-highlight">Evenly</div>
  </div>
</div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex align-items-start mb-md" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
  <div class="d-flex align-items-end mb-md" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
  <div class="d-flex align-items-center mb-md" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
  <div class="d-flex align-items-baseline mb-md" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex mb-md" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="align-self-start p-xs">Aligned flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
  <div class="d-flex mb-md" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="align-self-end p-xs">Aligned flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
  <div class="d-flex mb-md" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="align-self-center p-xs">Aligned flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
  <div class="d-flex mb-md" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="align-self-baseline p-xs">Aligned flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
  <div class="d-flex" style="height: 100px">
    <div class="p-xs">Flex item</div>
    <div class="align-self-stretch p-xs">Aligned flex item</div>
    <div class="p-xs">Flex item</div>
  </div>
</div>
...
<Example class="cxd-example-flex" code={`<div class="d-flex mb-md">
...
<Example class="cxd-example-flex" code={`<div class="d-flex align-items-start flex-column mb-md" style="height: 200px;">
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex flex-wrap">
    ...
    <div class="p-xs">Flex item 2</div>
    <div class="p-xs">Flex item 3</div>
    <div class="p-xs">Flex item 4</div>
    <div class="p-xs">Flex item 5</div>
    <div class="p-xs">Flex item 6</div>
    <div class="p-xs">Flex item 7</div>
    <div class="p-xs">Flex item 8</div>
    <div class="p-xs">Flex item 9</div>
    <div class="p-xs">Flex item 10</div>
    <div class="p-xs">Flex item 11</div>
    <div class="p-xs">Flex item 12</div>
    <div class="p-xs">Flex item 13</div>
    <div class="p-xs">Flex item 14</div>
  </div>
</div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex align-content-start flex-wrap mb-md" style="height: 200px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex align-content-end flex-wrap mb-md" style="height: 200px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex align-content-center flex-wrap mb-md" style="height: 200px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex align-content-between flex-wrap mb-md" style="height: 200px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex align-content-around flex-wrap mb-md" style="height: 200px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
...
<div class="cxd-example cxd-example-flex">
  <div class="d-flex align-content-stretch flex-wrap mb-md" style="height: 200px">
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
    <div class="p-xs">Flex item</div>
...
<div class="cxd-example cxd-example-flex vstack gap-md">
  <div class="d-grid gap-md place-items-start" style="grid-template-columns: 1fr 1fr 1fr; height: 150px;">
    <div class="p-sm">Place</div>
    <div class="p-sm">Items</div>
    <div class="p-sm">Start</div>
  </div>
  <div class="d-grid gap-md place-items-end" style="grid-template-columns: 1fr 1fr 1fr; height: 150px;">
    <div class="p-sm">Place</div>
    <div class="p-sm">Items</div>
    <div class="p-sm">End</div>
  </div>
  <div class="d-grid gap-md place-items-center" style="grid-template-columns: 1fr 1fr 1fr; height: 150px;">
    <div class="p-sm">Place</div>
    <div class="p-sm">Items</div>
    <div class="p-sm">Center</div>
  </div>
  <div class="d-grid gap-md place-items-stretch" style="grid-template-columns: 1fr 1fr 1fr; height: 150px;">
    <div class="p-sm">Place</div>
    <div class="p-sm">Items</div>
    <div class="p-sm">Stretch</div>
  </div>
</div>
