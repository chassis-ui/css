...
<Example class="d-flex overflow-auto" code={`<Placeholder width="140" height="80" class="small:object-fit-contain border rounded" text="Contain on small" markup="img" />
<Placeholder width="140" height="80" class="medium:object-fit-contain border rounded" text="Contain on medium" markup="img" />
<Placeholder width="140" height="80" class="large:object-fit-contain border rounded" text="Contain on large" markup="img" />
<Placeholder width="140" height="80" class="xlarge:object-fit-contain border rounded" text="Contain on xlarge" markup="img" />
<Placeholder width="140" height="80" class="2xlarge:object-fit-contain border rounded" text="Contain on 2xlarge" markup="img" />`} />
