    ...
    <div class="modal-window">
      ...
      <div class="modal-content">
        <div class="container fluid cxd-example-row">
          ...
          <div class="row">
            <div class="medium:col-3 ms-auto">.medium:col-3 .ms-auto</div>
            <div class="medium:col-2 ms-auto">.medium:col-2 .ms-auto</div>
          </div>
          <div class="row">
            <div class="medium:col-6 ms-auto">.medium:col-6 .ms-auto</div>
          </div>
          <div class="row">
            <div class="small:col-9">
              Level 1: .small:col-9
              <div class="row">
                <div class="col-8 small:col-6">
                  Level 2: .col-8 .small:col-6
                </div>
                <div class="col-4 small:col-6">
                  Level 2: .col-4 .small:col-6
                </div>
              </div>
            </div>
          </div>
...
<Example addStackblitzJs code={`<button type="button" class="button primary" data-cx-toggle="modal" data-cx-target="#dynamicModal" data-cx-whatever="@first">Content for first user</button>
...
<Example addStackblitzJs code={`<button class="button primary" data-cx-target="#firstModal" data-cx-toggle="modal">Open first modal</button>
<!-- First modal -->
...
<Example addStackblitzJs code={`<button class="button primary" data-cx-target="#baseModal" data-cx-toggle="modal">Open base modal</button>
<!-- Base modal -->
...
<JsDocs name="stacked-modal" file="site/src/assets/snippets.js" />
...
| `.small:down:fullscreen` | Fullscreen at the small breakpoint and below (< {`${sassBreakpointValue('small')}`}) |
| `.medium:down:fullscreen` | Fullscreen at the medium breakpoint and below (< {`${sassBreakpointValue('medium')}`}) |
| `.large:down:fullscreen` | Fullscreen at the large breakpoint and below (< {`${sassBreakpointValue('large')}`}) |
| `.xlarge:down:fullscreen` | Fullscreen at the xlarge breakpoint and below (< {`${sassBreakpointValue('xlarge')}`}) |
| `.2xlarge:down:fullscreen` | Fullscreen at the 2xlarge breakpoint and below (< {`${sassBreakpointValue('2xlarge')}`}) |
</CxTable>
...
<div class="modal fade" id="modalFullscreenSmall" tabindex="-1" aria-labelledby="modalFullscreenSmallLabel" aria-hidden="true">
  <div class="modal-container small:down:fullscreen">
    <div class="modal-window">
      <div class="modal-header">
...
<div class="modal fade" id="modalFullscreenLarge" tabindex="-1" aria-labelledby="modalFullscreenLargeLabel" aria-hidden="true">
  <div class="modal-container large:down:fullscreen">
    <div class="modal-window">
      <div class="modal-header">
...
<div class="modal fade" id="modalFullscreenXlarge" tabindex="-1" aria-labelledby="modalFullscreenXlargeLabel" aria-hidden="true">
  <div class="modal-container xlarge:down:fullscreen">
    <div class="modal-window">
      <div class="modal-header">
...
<div class="modal fade" id="modalFullscreen2xlarge" tabindex="-1" aria-labelledby="modalFullscreen2xlargeLabel" aria-hidden="true">
  <div class="modal-container 2xlarge:down:fullscreen">
    <div class="modal-window">
      <div class="modal-header">
