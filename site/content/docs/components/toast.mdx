...
<div class="toast-container position-fixed bottom-0 end-0 p-md">
  <div id="liveToast" class="toast" role="status">
    <div class="toast-header">
      <Placeholder width="20" height="20" background="#007aff" class="rounded me-xs" text={false} title={false} />
...
<Example code={`<div class="toast" role="status">
    <div class="toast-header">
      <Placeholder width="20" height="20" background="${colors.primary}" class="rounded me-xs" text={false} title={false} />
      <strong class="me-auto">Chassis</strong>
      <small>11 mins ago</small>
      <button type="button" class="close-button" data-cx-dismiss="toast" aria-label="Close"></button>
    </div>
...
<Example code={`<div class="toast" role="status">
    ...
    <div class="toast-footer">
      <button type="button" class="button primary sm">Take action</button>
      <button type="button" class="button secondary sm" data-cx-dismiss="toast">Close</button>
    </div>
  </div>`} />
...
<Example code={`<div class="toast justify-content-between" role="status">
    <div class="d-flex">
      ...
      <button type="button" class="close-button m-sm ms-auto" data-cx-dismiss="toast" aria-label="Close"></button>
    </div>
  </div>`} />
...
<Example class="cxd-example-toasts p-0" code={`<div aria-live="polite" aria-atomic="true" class="position-relative">
    <div class="toast-container top-0 end-0 p-md">
      <div class="toast" role="status">
        <div class="toast-header">
          <Placeholder width="20" height="20" background="${colors.primary}" class="rounded me-xs" text={false} title={false} />
          <strong class="me-auto">Chassis</strong>
...
<Example code={`<div class="toast-container position-static">
    ...
    <div class="toast context primary solid" role="status">
      <div class="toast-header">
        <Placeholder width="20" height="20" background="${colors.white}" class="rounded me-xs" text={false} title={false} />
        <strong class="me-auto">Chassis</strong>
...
<Example code={`<div class="toast border-danger bg-white fg-danger justify-content-between" role="alert">
    <div class="d-flex">
      ...
      <button type="button" class="close-button fg-black m-sm ms-auto" data-cx-dismiss="toast" aria-label="Close"></button>
    </div>
  </div>`} />
