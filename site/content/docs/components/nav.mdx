...
<Example code={`<ul class="nav nav-pills d-flex nav-fill flex-column sm:flex-row rounded-3xl">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example code={`<nav class="nav nav-pills d-flex nav-fill flex-column sm:flex-row rounded-3xl" aria-label="Fill navigation">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Much longer nav link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example code={`<ul class="nav nav-pills d-flex nav-justified flex-column md:flex-row rounded-3xl">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example code={`<nav class="nav nav-pills d-flex nav-justified flex-column md:flex-row rounded-3xl" aria-label="Justified navigation">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Much longer nav link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example code={`<ul class="nav flex-column">
    <li class="nav-item collapsible border-bottom">
      ...
      <div class="collapse" id="navCollapse1">
        <nav class="nav flex-column ps-md" aria-label="Collapsed Item submenu">
    ...
    <li class="nav-item collapsible">
      ...
      <div class="collapse show" id="navCollapse2">
        <nav class="nav flex-column ps-md" aria-label="Collapsible Item submenu">
          <a class="nav-link" href="#">Child item 1</a>
          <a class="nav-link" href="#">Child item 2</a>
          <a class="nav-link" href="#">Child item 3</a>
        </nav>
...
<Example code={`<ul class="nav flex-column" id="navAccordion">
    <li class="nav-item collapsible border-bottom">
      ...
      <div class="collapse show" id="navCollapse3" data-cx-parent="#navAccordion">
        <nav class="nav flex-column ps-md" aria-label="First accordion submenu">
          <a class="nav-link" href="#">Child item 1</a>
          <a class="nav-link" href="#">Child item 2</a>
          <a class="nav-link" href="#">Child item 3</a>
        </nav>
    ...
    <li class="nav-item collapsible collapsed border-bottom">
      ...
      <div class="collapse" id="navCollapse4" data-cx-parent="#navAccordion">
        <nav class="nav flex-column ps-md" aria-label="Second accordion submenu">
          <a class="nav-link" href="#">Child item 1</a>
          <a class="nav-link" href="#">Child item 2</a>
          <a class="nav-link" href="#">Child item 3</a>
        </nav>
    ...
    <li class="nav-item collapsible collapsed">
      ...
      <div class="collapse" id="navCollapse5" data-cx-parent="#navAccordion">
        <nav class="nav flex-column ps-md" aria-label="Third accordion submenu">
          <a class="nav-link" href="#">Child item 1</a>
          <a class="nav-link" href="#">Child item 2</a>
          <a class="nav-link" href="#">Child item 3</a>
        </nav>
