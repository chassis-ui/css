...
<Example code={`<ul class="nav nav-pills d-flex nav-fill flex-column sm:flex-row">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example code={`<nav class="nav nav-pills d-flex nav-fill flex-column sm:flex-row" aria-label="Fill navigation">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Much longer nav link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
...
<Example code={`<ul class="nav nav-pills d-flex nav-justified flex-column md:flex-row">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Active</a>
    </li>
    <li class="nav-item">
...
<Example code={`<nav class="nav nav-pills d-flex nav-justified flex-column md:flex-row" aria-label="Justified navigation">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
    <a class="nav-link" href="#">Much longer nav link</a>
    <a class="nav-link" href="#">Link</a>
    <a class="nav-link disabled" aria-disabled="true">Disabled</a>
