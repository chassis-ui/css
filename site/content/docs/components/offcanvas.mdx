...
<Example code={`<button class="button primary large:d-none" type="button" data-cx-toggle="offcanvas" data-cx-target="#offcanvasResponsive" aria-controls="offcanvasResponsive">Toggle offcanvas</button>
