...
<Example code={`<nav class="navbar bg-evident">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="/static/images/chassis-logo.svg" alt="Chassis CSS Logo" width="30" height="24">
      </a>
    </div>
  </nav>`} />
...
<Example code={`<nav class="navbar bg-evident">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="/static/images/chassis-logo.svg" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
        Chassis CSS
      </a>
    </div>
  </nav>`} />
