...
<ResizableExample code={`<nav class="navbar md:navbar-expand bg-even" aria-label="Main navigation">
    <div class="container fluid">
      ...
      <dialog class="drawer drawer-end" tabindex="-1" id="navbarDrawer" aria-labelledby="navbarDrawerLabel">
        ...
        <div class="drawer-body mb-sm md:mb-0">
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
              <button class="nav-link caret" type="button" data-cx-toggle="menu" aria-expanded="false">
                Menu
              </button>
              <div class="menu">
          ...
          <form class="hstack gap-sm" role="search">
...
<Example code={`<nav class="navbar bg-even" aria-label="Main navigation">
    <div class="container fluid">
      <a class="navbar-brand" href="#">
        ...
        <span class="ms-xs font-strong">CSS</span>
      </a>
    </div>
  </nav>`} />
...
<ResizableExample code={`<nav class="navbar sm:navbar-expand bg-even" aria-label="Main navigation">
    <div class="container fluid">
      <a class="navbar-brand" href="#">Navbar</a>
...
<Example code={`<nav class="navbar bg-even" aria-label="Main navigation">
    <div class="container fluid">
      <form class="d-flex" role="search">
        <input class="form-input me-sm" type="search" placeholder="Search" aria-label="Search"/>
...
<Example code={`<nav class="navbar bg-even" aria-label="Main navigation">
    <form class="container fluid justify-content-start">
      <button class="button primary outline me-sm" type="button">Main button</button>
      <button class="button sm secondary outline" type="button">Smaller button</button>
...
<ResizableExample code={`<nav class="navbar md:navbar-expand bg-even" aria-label="Main navigation">
    <div class="container fluid">
      ...
      <dialog class="drawer drawer-end" tabindex="-1" id="navbarText" aria-labelledby="navbarTextLabel">
        ...
        <div class="drawer-body">
          <ul class="navbar-nav me-auto mb-sm md:mb-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">Home</a>
            </li>
            <li class="nav-item">
...
<ResizableExample code={`<nav class="navbar md:navbar-expand bg-even" data-cx-theme="dark" aria-label="Main navigation">
    <div class="container fluid">
...
<ResizableExample containerClass="d-flex flex-column gap-sm" showMarkup={false} code={`
<nav class="navbar md:navbar-expand context primary solid" aria-label="Main navigation">
  <div class="container fluid">
    <a class="navbar-brand" href="#">Navbar</a>
    ...
    <dialog class="drawer drawer-end" tabindex="-1" id="navbarColor01" aria-labelledby="navbarColor01Label">
      ...
      <div class="drawer-body">
        ...
        <form class="d-flex" role="search">
          <input class="form-control me-sm" type="search" placeholder="Search" aria-label="Search"/>
...
<nav class="navbar md:navbar-expand context primary bg-even" data-cx-theme="dark" aria-label="Main navigation">
  <div class="container fluid">
    <a class="navbar-brand" href="#">Navbar</a>
    ...
    <dialog class="drawer drawer-end" tabindex="-1" id="navbarColor02" aria-labelledby="navbarColor02Label">
      ...
      <div class="drawer-body">
        ...
        <form class="d-flex" role="search">
          <input class="form-control me-sm" data-cx-theme="light" type="search" placeholder="Search" aria-label="Search"/>
          <button class="button default" type="submit">Search</button>
        </form>
      </div>
    </dialog>
...
<nav class="navbar md:navbar-expand context primary bg-even" data-cx-theme="light" aria-label="Main navigation">
  <div class="container fluid">
    <a class="navbar-brand" href="#">Navbar</a>
...
<Example class="cxd-pattern-dots z-0 primary-bg-even" code={`<nav class="navbar translucent md:navbar-expand" aria-label="Main navigation">
    <div class="container fluid">
      <a class="navbar-brand" href="#">Navbar</a>
      <ul class="navbar-nav">
        <li class="nav-item">
...
<Example code={`<div class="container">
    <nav class="navbar lg:navbar-expand bg-even" aria-label="Main navigation">
      <div class="container fluid">
        <a class="navbar-brand" href="#">Navbar</a>
      </div>
    </nav>
...
<Example code={`<nav class="navbar lg:navbar-expand bg-even" aria-label="Main navigation">
...
- `.sm:navbar-expand` — drawer below the sm breakpoint, inline at sm and above
- `.md:navbar-expand` — drawer below md, inline at md and above
- `.lg:navbar-expand` — drawer below lg, inline at lg and above
- `.xl:navbar-expand` — drawer below xl, inline at xl and above
- `.2xl:navbar-expand` — drawer below 2xl, inline at 2xl and above
