...
<Example code={`<button class="button default" type="button" aria-label="Loading">
  ...
  <button class="button primary large" type="button" aria-label="Loading">
    <span class="spinner-border" aria-hidden="true"></span>
  </button>
  <button class="button primary large" type="button" disabled aria-label="Loading">
    <span class="spinner-border" aria-hidden="true"></span>
  </button>
  <button class="button secondary small" type="button" aria-label="Loading">
