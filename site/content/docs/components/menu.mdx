...
Use [button]([[docsref:/components/button]]) elements with `.caret` [helper]([[docsref:/helpers/carets]]) as toggle triggers wherever possible — they handle keyboard activation natively. When a link element is used as a trigger, add `role="button"` to communicate its purpose to assistive technology. 

<Example code={`<button type="button" class="button primary caret" data-cx-toggle="menu" aria-expanded="false">
    Toggle menu
  </button>
  <div class="menu">
    <a class="menu-item" href="#">Copy</a>
...
Use [button group]([[docsref:/components/button-group]]) to build split buttons where a secondary toggle opens the menu while the primary button carries its own action.

<Example code={`<div class="button-group">
  <button type="button" class="button secondary">Split</button>
  <button type="button" class="button secondary caret icon-only" data-cx-toggle="menu" aria-expanded="false">
...
<Example code={`<div class="button-group">
  <button type="button" class="button secondary">Split</button>
  <button type="button" class="button secondary caret icon-only" data-cx-toggle="menu" aria-expanded="false" aria-label="Open actions menu">
...
<Example code={`<div class="menu show position-static p-md">
  <p>
...
For example, `data-cx-placement="bottom-start md:bottom-end lg:end-start"` applies `bottom-start` by default, switches to `bottom-end` at the `md` breakpoint, and to `end-start` at `lg`.

<Example class="d-flex flex-column lg:flex-row gap-sm" code={`<button class="button secondary" type="button" data-cx-toggle="menu" data-cx-placement="bottom-start md:bottom-end" aria-expanded="false">
...
<button class="button secondary" type="button" data-cx-toggle="menu" data-cx-placement="bottom lg:right" aria-expanded="false">
  bottom → lg:right
</button>
<div class="menu">
  <a class="menu-item" href="#">Copy</a>
...
<button class="button secondary" type="button" data-cx-toggle="menu" data-cx-placement="top-end md:right-start xl:bottom-start" aria-expanded="false">
  Multi-breakpoint
</button>
<div class="menu">
  <a class="menu-item" href="#">Copy</a>
...
Add `.submenu-stacked` alongside `.menu` on the inner menu to switch to a view-replacement pattern below the `sm` breakpoint. Add `<button class="submenu-back menu-item">` as the first item of each stacked level — the plugin wires the back action to close the submenu and return focus to its trigger. The button is hidden above the breakpoint, so a single markup pattern serves both layouts.
...
<Example class="d-flex flex-wrap gap-sm" code={`<div>
...
<Example class="hstack gap-md" code={`<div class="menu show position-static">
