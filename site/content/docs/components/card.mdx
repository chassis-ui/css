...
<Example code={`<div class="card mb-medium">
    <div class="row g-0">
      <div class="medium:col-4">
        ...
        <Placeholder width="100%" height="200" class="card-image-top d-block medium:d-none" text="Card image" aria-hidden="true" />
        <!-- Desktop image (shown only on medium screens and above) -->
        <Placeholder width="100%" height="100%" class="card-image-start h-100 d-none medium:d-block" text="Card image" />
      </div>
