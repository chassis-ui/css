...
<Example code={`<nav id="navbar-example2" class="navbar bg-evident px-md mb-md rounded-sm" aria-label="Scrollspy example navigation">
    ...
    <ul class="nav nav-pills">
      ...
      <li class="nav-item dropdown">
        <button type="button" class="nav-link caret" data-cx-toggle="menu" aria-expanded="false">Dropdown</button>
        <ul class="menu">
          <li><a class="menu-item" href="#scrollspyHeading3">Third</a></li>
          <li><a class="menu-item" href="#scrollspyHeading4">Fourth</a></li>
          <li><hr class="menu-divider"></li>
          <li><a class="menu-item" href="#scrollspyHeading5">Fifth</a></li>
        </ul>
      </li>
    </ul>
  </nav>
  <div class="scrollspy-example bg-evident p-md rounded-sm" data-cx-spy="scroll" data-cx-target="#navbar-example2" data-cx-root-margin="0px 0px -40%" data-cx-smooth-scroll="true" tabindex="0">
  ...
  customMarkup={`<nav id="navbar-example" class="navbar bg-evident px-md mb-md" aria-label="Scrollspy example navigation">
    <a class="navbar-brand" href="#">Navbar</a>
    <ul class="nav nav-pills">
      <li class="nav-item">
        <a class="nav-link" href="#scrollspyHeading1">First</a>
  ...
  <div data-cx-spy="scroll" data-cx-target="#navbar-example" data-cx-root-margin="0px 0px -40%" data-cx-smooth-scroll="true" class="scrollspy-example bg-evident p-md rounded-sm" tabindex="0">
    <h4 id="scrollspyHeading1">First heading</h4>
    <p>...</p>
    <h4 id="scrollspyHeading2">Second heading</h4>
    <p>...</p>
...
<Example code={`<div class="row">
    <div class="col-4">
      <nav id="nested-example2" class="h-100 flex-column align-items-stretch pe-lg border-end" aria-label="Nested scrollspy navigation">
        <nav class="nav nav-pills flex-column rounded-3xl" aria-label="Main sections">
          <a class="nav-link" href="#item-1">Item 1</a>
          <nav class="nav nav-pills flex-column" aria-label="Item 1 subsections">
            <a class="nav-link ms-md my-2xs" href="#item-1-1">Item 1-1</a>
            <a class="nav-link ms-md my-2xs" href="#item-1-2">Item 1-2</a>
          </nav>
          <a class="nav-link" href="#item-2">Item 2</a>
          <a class="nav-link" href="#item-3">Item 3</a>
          <nav class="nav nav-pills flex-column" aria-label="Item 3 subsections">
            <a class="nav-link ms-md my-2xs" href="#item-3-1">Item 3-1</a>
            <a class="nav-link ms-md my-2xs" href="#item-3-2">Item 3-2</a>
          </nav>
        </nav>
      </nav>
    </div>
    <div class="col-8">
      <div data-cx-spy="scroll" data-cx-target="#nested-example2" data-cx-smooth-scroll="true" class="scrollspy-example-2" tabindex="0">
        <div id="item-1">
          <h4>Item 1</h4>
          <p>This is some placeholder content for the scrollspy page. Note that as you scroll down the page, the appropriate navigation link is highlighted. It's repeated throughout the component example. We keep adding some more example copy here to emphasize the scrolling and highlighting.</p>
  ...
  customMarkup={`<div class="row">
    <div class="col-4">
      <nav id="nested-example" class="h-100 flex-column align-items-stretch pe-lg border-end" aria-label="Nested scrollspy navigation">
        <nav class="nav nav-pills flex-column rounded-3xl" aria-label="Main sections">
          <a class="nav-link" href="#item-1">Item 1</a>
          <nav class="nav nav-pills flex-column" aria-label="Item 1 subsections">
            <a class="nav-link ms-md my-2xs" href="#item-1-1">Item 1-1</a>
    ...
    <div class="col-8">
      <div data-cx-spy="scroll" data-cx-target="#nested-example" data-cx-smooth-scroll="true" class="scrollspy-example-2" tabindex="0">
        <div id="item-1">
          <h4>Item 1</h4>
          <p>...</p>
        </div>
...
<Example code={`<div class="cxd-example">
    <div class="row">
      <div class="col-4">
        <div id="list-example2" class="list">
      ...
      <div class="col-8">
        <div data-cx-spy="scroll" data-cx-target="#list-example2" data-cx-smooth-scroll="true" class="scrollspy-example" tabindex="0">
...
<Example code={`<div class="cxd-example">
    <div class="row">
      <div class="col-4">
        <div id="simple-list-example2" class="d-flex flex-column gap-xs simple-list-example-scrollspy text-center">
          <a class="p-2xs rounded" href="#simple-list-item-1">Item 1</a>
          <a class="p-2xs rounded" href="#simple-list-item-2">Item 2</a>
          <a class="p-2xs rounded" href="#simple-list-item-3">Item 3</a>
          <a class="p-2xs rounded" href="#simple-list-item-4">Item 4</a>
          <a class="p-2xs rounded" href="#simple-list-item-5">Item 5</a>
        </div>
      </div>
      <div class="col-8">
        <div data-cx-spy="scroll" data-cx-target="#simple-list-example2" data-cx-offset="0" data-cx-smooth-scroll="true" class="scrollspy-example" tabindex="0">
  ...
  customMarkup={`<div class="row">
    <div class="col-4">
      <div id="simple-list-example" class="d-flex flex-column gap-xs simple-list-example-scrollspy text-center">
        <a class="p-2xs rounded" href="#simple-list-item-1">Item 1</a>
        <a class="p-2xs rounded" href="#simple-list-item-2">Item 2</a>
        <a class="p-2xs rounded" href="#simple-list-item-3">Item 3</a>
        <a class="p-2xs rounded" href="#simple-list-item-4">Item 4</a>
