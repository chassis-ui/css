...
<Example code={`<nav id="navbar-example2" class="navbar bg-evident px-medium mb-medium rounded-small" aria-label="Scrollspy example navigation">
    ...
    <ul class="nav nav-pills">
      ...
      <li class="nav-item dropdown">
        <button type="button" class="nav-link menu-toggle" data-cx-toggle="menu" aria-expanded="false">Dropdown</button>
        <ul class="menu">
  ...
  <div class="scrollspy-example bg-evident p-medium rounded-small" data-cx-spy="scroll" data-cx-target="#navbar-example2" data-cx-root-margin="0px 0px -40%" data-cx-smooth-scroll="true" tabindex="0">
  ...
  customMarkup={`<nav id="navbar-example" class="navbar bg-evident px-medium mb-medium" aria-label="Scrollspy example navigation">
    <a class="navbar-brand" href="#">Navbar</a>
    <ul class="nav nav-pills">
      <li class="nav-item">
        <a class="nav-link" href="#scrollspyHeading1">First</a>
  ...
  <div data-cx-spy="scroll" data-cx-target="#navbar-example" data-cx-root-margin="0px 0px -40%" data-cx-smooth-scroll="true" class="scrollspy-example bg-evident p-medium rounded-small" tabindex="0">
    <h4 id="scrollspyHeading1">First heading</h4>
    <p>...</p>
    <h4 id="scrollspyHeading2">Second heading</h4>
    <p>...</p>
...
<Example code={`<div class="row">
    <div class="col-4">
      <nav id="nested-example2" class="h-100 flex-column align-items-stretch pe-large border-end" aria-label="Nested scrollspy navigation">
        <nav class="nav nav-pills flex-column rounded-3xlarge" aria-label="Main sections">
  ...
  customMarkup={`<div class="row">
    <div class="col-4">
      <nav id="nested-example" class="h-100 flex-column align-items-stretch pe-large border-end" aria-label="Nested scrollspy navigation">
        <nav class="nav nav-pills flex-column rounded-3xlarge" aria-label="Main sections">
          <a class="nav-link" href="#item-1">Item 1</a>
          <nav class="nav nav-pills flex-column" aria-label="Item 1 subsections">
            <a class="nav-link ms-medium my-2xsmall" href="#item-1-1">Item 1-1</a>
...
<Example code={`<div class="cxd-example">
    <div class="row">
      <div class="col-4">
        <div id="simple-list-example2" class="d-flex flex-column gap-xsmall simple-list-example-scrollspy text-center">
