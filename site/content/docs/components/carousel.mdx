...
<Example code={`<div id="carouselExample" class="carousel slide">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <Placeholder width="800" height="400" class="cxd-placeholder-image-lg d-block w-100" color="var(--cx-neutral-50)" background="var(--cx-neutral-30)" text="First slide" />
      </div>
      <div class="carousel-item">
        <Placeholder width="800" height="400" class="cxd-placeholder-image-lg d-block w-100" color="var(--cx-neutral-60)" background="var(--cx-neutral-40)" text="Second slide" />
      </div>
      <div class="carousel-item">
        <Placeholder width="800" height="400" class="cxd-placeholder-image-lg d-block w-100" color="var(--cx-neutral-30)" background="var(--cx-neutral-50)" text="Third slide" />
      </div>
    </div>
  </div>`} />
...
<Example code={`<div id="carouselExampleInterval" class="carousel slide" data-cx-autoplay="true">
    <div class="carousel-inner rounded-5">
      <div class="carousel-item active" data-cx-interval="2000">
        <Placeholder width="800" height="400" class="cxd-placeholder-image-lg d-block w-100" color="var(--cx-neutral-50)" background="var(--cx-neutral-30)" text="First: 2 seconds" />
      </div>
      <div class="carousel-item" data-cx-interval="4000">
        <Placeholder width="800" height="400" class="cxd-placeholder-image-lg d-block w-100" color="var(--cx-neutral-60)" background="var(--cx-neutral-40)" text="Second: 4 seconds" />
      </div>
      <div class="carousel-item" data-cx-interval="6000">
        <Placeholder width="800" height="400" class="cxd-placeholder-image-lg d-block w-100" color="var(--cx-neutral-30)" background="var(--cx-neutral-50)" text="Third: 6 seconds" />
      </div>
    </div>
...
<Example code={`<div id="carouselEndsLoop" class="carousel slide" data-cx-ends="loop">
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <Placeholder width="800" height="400" class="cxd-placeholder-image-lg d-block w-100" color="var(--cx-neutral-70)" background="var(--cx-neutral-50)" text="Third slide" />
      </div>
    </div>
...
<Example code={`<div id="carouselMultiple" class="carousel slide" data-cx-ends="stop" 
    ...
    <div class="carousel-inner">
      <div class="carousel-item active"><Placeholder width="260" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="1" /></div>
      <div class="carousel-item"><Placeholder width="260" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="2" /></div>
      <div class="carousel-item"><Placeholder width="260" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="3" /></div>
      <div class="carousel-item"><Placeholder width="260" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="4" /></div>
      <div class="carousel-item"><Placeholder width="260" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="5" /></div>
      <div class="carousel-item"><Placeholder width="260" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="6" /></div>
      <div class="carousel-item"><Placeholder width="260" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="7" /></div>
    </div>
    <div class="d-flex justify-content-center">
...
<Example code={`<div id="carouselPeek" class="carousel slide" data-cx-ends="stop" 
    ...
    <div class="carousel-inner">
      <div class="carousel-item active"><Placeholder width="800" height="300" class="cxd-placeholder-image-lg d-block w-100 rounded-xl" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="First slide" /></div>
      <div class="carousel-item"><Placeholder width="800" height="300" class="cxd-placeholder-image-lg d-block w-100 rounded-xl" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="Second slide" /></div>
      <div class="carousel-item"><Placeholder width="800" height="300" class="cxd-placeholder-image-lg d-block w-100 rounded-xl" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="Third slide" /></div>
      <div class="carousel-item"><Placeholder width="800" height="300" class="cxd-placeholder-image-lg d-block w-100 rounded-xl" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="Fourth slide" /></div>
      <div class="carousel-item"><Placeholder width="800" height="300" class="cxd-placeholder-image-lg d-block w-100 rounded-xl" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="Fifth slide" /></div>
    </div>
    <div class="d-flex justify-content-center">
...
<Example code={`<div id="carouselVariable" class="carousel carousel-auto slide" data-cx-ends="stop" style="--cx-carousel-items-gap: 1rem;"><!--[!code highlight]-->
    <div class="carousel-inner">
      <div class="carousel-item active" style="width: 160px;"><!--[!code highlight]-->
        <Placeholder width="160" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="A" />
      </div>
      <div class="carousel-item" style="width: 320px;"><!--[!code highlight]-->
        <Placeholder width="320" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="B" />
      </div>
      <div class="carousel-item" style="width: 220px;"><!--[!code highlight]-->
        <Placeholder width="220" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="C" />
      </div>
      <div class="carousel-item" style="width: 380px;"><!--[!code highlight]-->
        <Placeholder width="380" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="D" />
      </div>
      <div class="carousel-item" style="width: 200px;"><!--[!code highlight]-->
        <Placeholder width="200" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="E" />
      </div>
      <div class="carousel-item" style="width: 300px;"><!--[!code highlight]-->
        <Placeholder width="300" height="200" class="cxd-placeholder-image-lg d-block w-100 rounded" color="var(--cx-neutral-fg-subtle)" background="var(--cx-neutral-bg-evident)" text="F" />
      </div>
    </div>
    <div class="d-flex justify-content-center">
