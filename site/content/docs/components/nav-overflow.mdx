...
<ResizableExample code={`<ul class="nav nav-pills" data-cx-toggle="nav-overflow">
    <li class="nav-item">
...
<ResizableExample code={`<ul class="nav nav-tabs" data-cx-toggle="nav-overflow">
    <li class="nav-item">
...
<ResizableExample code={`<ul class="nav nav-underline" data-cx-toggle="nav-overflow">
    <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Home</a>
    </li>
    <li class="nav-item">
