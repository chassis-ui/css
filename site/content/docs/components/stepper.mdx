...
<ResizableExample code={`<div class="contains-inline">
    <ol class="stepper sm:horizontal">
      <li class="stepper-item">First Step</li>
      <li class="stepper-item">Past Step</li>
      <li class="stepper-item active" aria-current="step">Current Step</li>
      <li class="stepper-item">Next Step</li>
...
<Example code={`<ol class="stepper horizontal">
      <li class="stepper-item"><span class="d-none lg:d-block">First Step</span></li>
      <li class="stepper-item"><span class="d-none lg:d-block">Past Step</span></li>
      <li class="stepper-item active" aria-current="step"><span class="d-none lg:d-block">Current Step</span></li>
      <li class="stepper-item"><span class="d-none lg:d-block">Next Step</span></li>
      <li class="stepper-item"><span class="d-none lg:d-block">Last Step</span></li>
    </ol>`} />
