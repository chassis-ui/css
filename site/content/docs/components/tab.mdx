...
<Example class="vstack gap-md" code={`<ul class="nav nav-tabs" id="myTab" role="tablist">
...
<Example class="vstack gap-md" code={`<nav aria-label="Tab navigation">
...
<Example class="vstack gap-md" code={`<ul class="nav nav-pills" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
...
<Example class="vstack gap-md" code={`<div class="row">
  <div class="col-4">
