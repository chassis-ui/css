...
<Example class="button-examples" code={`<button type="button" class="button default icon-only" aria-label="Info">
  ...
  <button type="button" class="button small default icon-only" aria-label="Info">
    <Icon name="info-circle-solid" font />
  </button>
  <button type="button" class="button small primary icon-only" aria-label="Info">
    <Icon name="info-circle-solid" font />
  </button>
  <button type="button" class="button large default icon-only" aria-label="Info">
    <Icon name="info-circle-solid" font />
  </button>
  <button type="button" class="button default large icon-only" aria-label="Info">
    <Icon name="info-circle-solid" role="img" />
  </button>
  <button type="button" class="button large primary icon-only" aria-label="Info">
    <Icon name="info-circle-solid" font />
  </button>`} />
...
<Example class="button-examples" code={`<div class="d-grid gap-xsmall medium:d-block">
    <button class="button default" type="button">Default</button>
    <button class="button primary" type="button">Primary</button>
  </div>`} />
...
<Example class="button-examples" code={`<div class="d-grid gap-xsmall medium:d-flex medium:justify-content-end">
    <button class="button default" type="button">Default</button>
    <button class="button primary" type="button">Primary</button>
  </div>`} />
