---
title: Color System
description: A layered color architecture — primitive scales, semantic context palettes, and body variables — that gives Chassis CSS consistent, flexible theming across light and dark modes.
toc: true
---
...
The [`.context` class]([[docsref:/core-concepts/context-class]]) is how you re-aim those body variables in markup. Add `class="context primary"` to any element and its body variables instantly switch to the `primary` palette — for that element and everything inside it.
