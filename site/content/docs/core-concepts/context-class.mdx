...
<Example code={[`<p class="p-xs">
    <Icon name="info-circle-solid" font />
    This is the body context <a href="#">with link</a>, same as default.
  </p>`].concat(getData('context-colors').map((color) => `<p class="context ${color.name} p-xs">
    <Icon name="info-circle-solid" font />
...
<Example code={`<p class="example-3 p-xs">--cx-fg-main</p>
<p class="example-3 primary p-xs">--cx-fg-main</p>
<p class="example-3 primary solid p-xs">--cx-fg-main</p>`} />
