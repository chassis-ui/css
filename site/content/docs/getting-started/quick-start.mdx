...
<html lang="en">
  ...
  <body>
    <main class="container py-lg">
      <h1 class="mb-md">Hello, world!</h1>
      <p class="fg-subtle mb-lg">A button, a notification, a card — rendered with the default brand and settings.</p>

      <button class="button primary">Primary button</button>
      <button class="button primary outline">Outline button</button>

      <div class="notification info my-xl">
