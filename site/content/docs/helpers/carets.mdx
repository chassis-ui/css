...
<Example class="hstack gap-lg" code={`<span class="caret">Default caret</span>
...
<Example class="hstack gap-lg" code={`<span class="caret">Trailing caret</span>
...
<Example class="hstack gap-lg" code={`<span class="caret">Down</span>
...
<Example class="hstack gap-lg" code={`<span class="caret-before caret-start">Back</span>`} />
...
<Example class="hstack gap-lg" code={`<span class="caret" style="
    --cx-caret-size: 2em; 
...
<Example class="vstack gap-sm" code={`<div class="form-input form-caret">Choose an option</div>
