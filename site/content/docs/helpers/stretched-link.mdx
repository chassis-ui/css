...
<Example code={`<div class="d-flex position-relative">
    <Placeholder width="144" height="144" class="flex-shrink-0 me-md" text={false} title="Generic placeholder image22222" />
    <div>
      <h2 class="font-xl mt-0">Custom component with stretched link</h2>
...
<Example code={`<div class="row g-0 bg-evident position-relative">
    <div class="md:col-6 md:mb-0 md:p-lg">
      <Placeholder width="100%" height="200" class="w-100" text={false} title="Generic placeholder image" />
    </div>
    <div class="md:col-6 p-lg md:ps-0">
      <h2 class="font-xl mt-0">Columns with stretched link</h2>
