...
<Example code={[...getData('context-colors').map((color) => `<p class="bg-${color.name} fg-contrast p-xs">${color.name.charAt(0).toUpperCase() + color.name.slice(1)} background with contrast color text.</p>`)]} />
...
<Example code={[...getData('context-colors').map((color) => `<p class="fg-${color.name} bg-contrast p-xs">${color.name.charAt(0).toUpperCase() + color.name.slice(1)} text with contrast color background.</p>`)]} />
...
<Example code={[...getData('context-colors').map((color) => `<p class="bg-${color.name} fg-a11y p-xs">${color.name.charAt(0).toUpperCase() + color.name.slice(1)} background with accessible color text.</p>`)]} />
...
<Example code={[...getData('context-colors').map((color) => `<p class="fg-${color.name} bg-a11y p-xs">${color.name.charAt(0).toUpperCase() + color.name.slice(1)} text with accessible color background.</p>`)]} />
...
<Example class="d-flex flex-column lg:flex-row gap-md" code={`<div class="card bg-primary fg-contrast">
