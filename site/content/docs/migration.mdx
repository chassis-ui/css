...
Chassis - CSS v5.2.0 features a subtle design update for a handful of components and properties across the project, **most notably through refined `border-radius` values on buttons and form inputs**. Our documentation also has been updated with a new homepage, simpler docs layout that no longer collapses sections of the sidebar, and more prominent examples of Chassis - Icons.
...
- Replaced chevron icons for carousel controls with new SVGs from Chassis - Icons.
