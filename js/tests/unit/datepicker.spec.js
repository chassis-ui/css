...
describe('Datepicker', () => {
  ...
  describe('Default', () => {
    ...
    it('should have expected default values', () => {
      ...
      expect(Datepicker.Default.locale).toEqual(navigator.language.substring(0, 2))
  ...
  describe('DATA_KEY', () => {
    it('should return plugin data key', () => {
      expect(Datepicker.DATA_KEY).toEqual('cx.datepicker')
    })
  })
  ...
  describe('constructor', () => {
    it('should take care of element either passed as a CSS selector or DOM element', () => {
      fixtureEl.innerHTML = '<input type="text" id="datepickerEl" data-cx-toggle="datepicker">'
    ...
    it('should detect button element type', () => {
      fixtureEl.innerHTML = '<button type="button" data-cx-toggle="datepicker">Select date</button>'
    ...
    it('should use config from data attributes', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-selection-mode="multiple-ranged" data-cx-first-weekday="0">'
    ...
    it('should merge passed config with data attributes', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-first-weekday="0">'
  ...
  describe('show', () => {
    ...
    it('should trigger show.cx.datepicker event', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker">'
        ...
        inputEl.addEventListener('show.cx.datepicker', event => {
    ...
    it('should trigger shown.cx.datepicker event', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker">'
        ...
        inputEl.addEventListener('shown.cx.datepicker', event => {
          expect(event).toBeDefined()
          resolve()
        })
    ...
    it('should not show if disabled', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" disabled>'
  ...
  describe('hide', () => {
    it('should hide the calendar popup', () => {
      return new Promise(resolve => {
        ...
        inputEl.addEventListener('hidden.cx.datepicker', () => {
          expect(datepicker._isShown).toBeFalse()
          resolve()
        })
    ...
    it('should trigger hide.cx.datepicker event', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker">'
        ...
        inputEl.addEventListener('hide.cx.datepicker', event => {
          expect(event).toBeDefined()
          resolve()
        })
    ...
    it('should trigger hidden.cx.datepicker event', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker">'
        ...
        inputEl.addEventListener('hidden.cx.datepicker', event => {
          expect(event).toBeDefined()
          resolve()
        })
  ...
  describe('options', () => {
    it('should respect dateMin option', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-date-min="2026-01-01">'
    ...
    it('should respect dateMax option', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-date-max="2026-12-31">'
    ...
    it('should respect placement option', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-placement="right">'
    ...
    it('should respect displayMonthsCount option', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-display-months-count="2">'
    ...
    it('should respect locale option', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-locale="de-DE">'
    ...
    it('should respect datepickerTheme option', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-datepicker-theme="dark">'
  ...
  describe('theme detection', () => {
    it('should detect theme from closest [data-cx-theme] ancestor', () => {
      fixtureEl.innerHTML = [
        '<div data-cx-theme="dark">',
        '  <input type="text" data-cx-toggle="datepicker">',
        '</div>'
      ].join('')
    ...
    it('should use explicit datepickerTheme config over ancestor', () => {
      fixtureEl.innerHTML = [
        '<div data-cx-theme="dark">',
        '  <input type="text" data-cx-toggle="datepicker" data-cx-datepicker-theme="light">',
        '</div>'
      ].join('')
    ...
    it('should set data-cx-theme on calendar element when ancestor has theme', () => {
      fixtureEl.innerHTML = [
        '<div data-cx-theme="dark">',
        '  <input type="text" data-cx-toggle="datepicker">',
        '</div>'
      ...
      expect(calendarEl.getAttribute('data-cx-theme')).toEqual('dark')
    })

    it('should not have data-cx-theme when no theme is set', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker">'
      ...
      const calendarEl = datepicker._calendar.context.mainElement
      expect(calendarEl.hasAttribute('data-cx-theme')).toBeFalse()
    })
  })
  ...
  describe('button trigger', () => {
    ...
    it('should use [data-cx-datepicker-display] child if present', () => {
      fixtureEl.innerHTML = [
        '<button type="button" data-cx-toggle="datepicker">',
        '  <span>Icon</span>',
      ...
      const buttonEl = fixtureEl.querySelector('button')
      const displayEl = fixtureEl.querySelector('[data-cx-datepicker-display]')
      const datepicker = new Datepicker(buttonEl)
  ...
  describe('date formatting', () => {
    ...
    it('should use comma for multiple dates', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-selection-mode="multiple">'
  ...
  describe('inline mode', () => {
    ...
    it('should not look for hidden input when element is an input', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" data-cx-inline="true">'
  ...
  describe('data-api', () => {
    it('should toggle on click for buttons', () => {
      return new Promise(resolve => {
        ...
        buttonEl.addEventListener('shown.cx.datepicker', () => {
  ...
  describe('input value parsing', () => {
    it('should parse initial input value', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" value="2026-01-15">'
    ...
    it('should handle invalid input value gracefully', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" value="not-a-date">'
    ...
    it('should handle empty input value', () => {
      fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker" value="">'
  ...
  describe('date selection handling', () => {
    it('should trigger change.cx.datepicker event on date click', () => {
      return new Promise(resolve => {
        fixtureEl.innerHTML = '<input type="text" data-cx-toggle="datepicker">'
        ...
        inputEl.addEventListener('change.cx.datepicker', event => {
  ...
  describe('_resolveDisplayElement', () => {
    it('should resolve selector string to element', () => {
      fixtureEl.innerHTML = [
        ...
        '<button type="button" data-cx-toggle="datepicker">Click</button>'
      ].join('')
