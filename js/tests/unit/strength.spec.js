...
describe('Strength', () => {
  ...
  const getStrengthBarHtml = (inputId = 'password') => {
    return `
      <div>
        <input type="password" id="${inputId}" class="form-control">
        <div class="strength-bar" data-cx-strength></div>
      </div>
    `
  }
  ...
  describe('DATA_KEY', () => {
    it('should return plugin data key', () => {
      expect(Strength.DATA_KEY).toEqual('cx.strength')
    })
  })
  ...
  describe('UI updates', () => {
    it('should set data-cx-strength attribute', () => {
      fixtureEl.innerHTML = getStrengthHtml()
      ...
      expect(strengthEl.dataset.cxStrength).toEqual('weak')
    })

    it('should remove data-cx-strength attribute when empty', () => {
      fixtureEl.innerHTML = getStrengthHtml()
      ...
      expect(strengthEl.dataset.cxStrength).toBeUndefined()
    })
  ...
  describe('events', () => {
    it('should trigger strengthChange event', () => {
      return new Promise(resolve => {
        ...
        strengthEl.addEventListener('strengthChange.cx.strength', event => {
