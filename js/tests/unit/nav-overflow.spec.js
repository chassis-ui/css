...
describe('NavOverflow', () => {
  ...
  describe('DATA_KEY', () => {
    it('should return plugin data key', () => {
      expect(NavOverflow.DATA_KEY).toEqual('cx.navoverflow')
    })
  })
  ...
  describe('constructor', () => {
    it('should take care of element either passed as a CSS selector or DOM element', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" data-cx-toggle="nav-overflow">',
        '  <ul class="nav">',
      ...
      const wrapperEl = fixtureEl.querySelector('[data-cx-toggle="nav-overflow"]')
      const navBySelector = new NavOverflow('[data-cx-toggle="nav-overflow"]')
    ...
    it('should throw when the wrapper has no child nav', () => {
      fixtureEl.innerHTML = '<div class="nav-overflow" data-cx-toggle="nav-overflow"></div>'
    ...
    it('should add nav-overflow class to the wrapper', () => {
      fixtureEl.innerHTML = [
        '<div data-cx-toggle="nav-overflow">',
        '  <ul class="nav">',
        '    <li class="nav-item"><a class="nav-link" href="#">Link 1</a></li>',
        '  </ul>',
        '</div>'
    ...
    it('should create overflow menu toggle and menu inside the nav', () => {
      ...
      expect(toggle.getAttribute('data-cx-toggle')).toEqual('menu')
    ...
    it('should store order data on nav items', () => {
      ...
      expect(items[0].dataset.cxNavOrder).toEqual('0')
      expect(items[1].dataset.cxNavOrder).toEqual('1')
      expect(items[2].dataset.cxNavOrder).toEqual('2')
  ...
  describe('update', () => {
    it('should trigger update event on the wrapper', () => {
      return new Promise(resolve => {
        ...
        wrapperEl.addEventListener('update.cx.navoverflow', () => {
          navOverflow.dispose()
          resolve()
        })
  ...
  describe('overflow behavior', () => {
    it('should use placement option for overflow menu', () => {
      ...
      expect(toggle.getAttribute('data-cx-toggle')).toEqual('menu')
      expect(toggle.getAttribute('data-cx-placement')).toEqual('bottom-end')
    ...
    it('should preserve nav-overflow-keep items', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" style="width: 100px;" data-cx-toggle="nav-overflow">',
    ...
    it('should hide items that overflow the wrapper width', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" style="width: 250px;" data-cx-toggle="nav-overflow">',
        '  <ul class="nav" style="display: flex;">',
      ...
      const hiddenItems = wrapperEl.querySelectorAll('.nav-item[data-cx-nav-overflow="true"]')
    ...
    it('should measure the wrapper, not the nav, when the nav sizes to its content', () => {
      ...
      expect(wrapperEl.querySelectorAll('.nav-item[data-cx-nav-overflow="true"]').length).toBeGreaterThan(0)
    ...
    it('should hide overflow toggle when no items overflow', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" style="width: 5000px;" data-cx-toggle="nav-overflow">',
        '  <ul class="nav" style="display: flex;">',
    ...
    it('should preserve active state on cloned menu items', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" style="width: 150px;" data-cx-toggle="nav-overflow">',
        '  <ul class="nav" style="display: flex;">',
        '    <li class="nav-item" style="flex: 0 0 100px; width: 100px;"><a class="nav-link" href="#">Link 1</a></li>',
      ...
      const originalActiveHidden = wrapperEl.querySelector('.nav-item[data-cx-nav-overflow="true"] .nav-link.active')
    ...
    it('should preserve disabled state on cloned menu items', () => {
      ...
      const originalDisabledHidden = wrapperEl.querySelector('.nav-item[data-cx-nav-overflow="true"] .nav-link.disabled')
    ...
    it('should fire overflow event on the wrapper with overflowCount and visibleCount', () => {
      ...
      wrapperEl.addEventListener('overflow.cx.navoverflow', event => {
        eventFired = true
    ...
    it('should restore items when update causes no overflow', () => {
      ...
      const hiddenBefore = wrapperEl.querySelectorAll('.nav-item[data-cx-nav-overflow="true"]')
      ...
      const hiddenAfter = wrapperEl.querySelectorAll('.nav-item[data-cx-nav-overflow="true"]')
    ...
    it('should reuse existing overflow toggle and menu from markup', () => {
      fixtureEl.innerHTML = [
        ...
        '      <button class="nav-link nav-overflow-toggle" type="button" data-cx-toggle="menu">More</button>',
  ...
  describe('config', () => {
    ...
    it('should respect custom menuPlacement option', () => {
      ...
      const toggle = wrapperEl.querySelector('.nav-overflow-toggle')
      expect(toggle.getAttribute('data-cx-placement')).toEqual('bottom-start')

      navOverflow.dispose()
    })

    it('should use a child element with [data-cx-overflow-icon] as the icon', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" data-cx-toggle="nav-overflow">',
        '  <ul class="nav">',
        '    <li class="nav-item"><a class="nav-link" href="#">Link 1</a></li>',
        '  </ul>',
        '  <svg data-cx-overflow-icon class="bi-chevron" width="16" height="16"><circle cx="8" cy="8" r="8"/></svg>',
        '</div>'
      ].join('')
      ...
      expect(svg.hasAttribute('data-cx-overflow-icon')).toBeFalse()

      // Original element should be removed from the wrapper
      expect(wrapperEl.querySelector('[data-cx-overflow-icon]')).toBeNull()

      navOverflow.dispose()
    })

    it('should prefer child [data-cx-overflow-icon] over moreIcon config', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" data-cx-toggle="nav-overflow">',
        '  <ul class="nav">',
        '    <li class="nav-item"><a class="nav-link" href="#">Link 1</a></li>',
        '  </ul>',
        '  <svg data-cx-overflow-icon class="from-markup" width="16" height="16"><circle cx="8" cy="8" r="8"/></svg>',
        '</div>'
      ].join('')
    ...
    it('should not let menuPlacement break out of its attribute', () => {
      ...
      const toggle = wrapperEl.querySelector('.nav-overflow-toggle')
      expect(toggle.getAttribute('data-cx-placement')).toEqual(maliciousPlacement)
    ...
    it('should sanitize markup from [data-cx-overflow-icon]', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" data-cx-toggle="nav-overflow">',
        '  <ul class="nav">',
        '    <li class="nav-item"><a class="nav-link" href="#">Link 1</a></li>',
        '  </ul>',
        '  <span data-cx-overflow-icon class="from-markup"><img src=x onerror="window.__navCustomIconXss=1"><i class="bi-ok"></i></span>',
        '</div>'
      ].join('')
  ...
  describe('collapseBelow', () => {
    it('should collapse all items when the wrapper width is below collapseBelow (number)', () => {
      fixtureEl.innerHTML = [
        '<div class="nav-overflow" style="width: 400px;" data-cx-toggle="nav-overflow">',
        '  <ul class="nav" style="display: flex;">',
        '    <li class="nav-item" style="flex: 0 0 50px; width: 50px;"><a class="nav-link" href="#">Link 1</a></li>',
        '    <li class="nav-item" style="flex: 0 0 50px; width: 50px;"><a class="nav-link" href="#">Link 2</a></li>',
    ...
    it('should resolve a breakpoint string via --cx-breakpoint-{name} CSS variable', () => {
      document.documentElement.style.setProperty('--cx-breakpoint-md', '768px')
      ...
      navOverflow.dispose()
      document.documentElement.style.removeProperty('--cx-breakpoint-md')
    })
  ...
  describe('dispose', () => {
    ...
    it('should remove only its own fallback window resize listener on dispose', () => {
      ...
      try {
        fixtureEl.innerHTML = [
          '<div class="nav-overflow" id="navA" data-cx-toggle="nav-overflow">',
          '  <ul class="nav">',
          '    <li class="nav-item"><a class="nav-link" href="#">Link 1</a></li>',
          '  </ul>',
          '</div>',
          '<div class="nav-overflow" id="navB" data-cx-toggle="nav-overflow">',
          '  <ul class="nav">',
          '    <li class="nav-item"><a class="nav-link" href="#">Link 1</a></li>',
          '  </ul>',
          '</div>'
        ...
        expect(spyOff).toHaveBeenCalledWith(window, 'resize.cx.navoverflow', handlerA)
        expect(spyOff).not.toHaveBeenCalledWith(window, 'resize.cx.navoverflow', handlerB)
      } finally {
