...
describe('NavOverflow', () => {
  ...
  describe('constructor', () => {
    it('should take care of element either passed as a CSS selector or DOM element', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav" data-cx-toggle="nav-overflow">',
        '  <li class="nav-item"><a class="nav-link" href="#">Link 1</a></li>',
        '  <li class="nav-item"><a class="nav-link" href="#">Link 2</a></li>',
        '</ul>'
      ].join('')

      const navEl = fixtureEl.querySelector('[data-cx-toggle="nav-overflow"]')
  ...
  describe('update', () => {
    it('should trigger update event', () => {
      return new Promise(resolve => {
        ...
        navEl.addEventListener('update.cx.navoverflow', () => {
          navOverflow.dispose()
          resolve()
        })
  ...
  describe('overflow behavior', () => {
    ...
    it('should preserve nav-overflow-keep items', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav" style="width: 100px;" data-cx-toggle="nav-overflow">',
    ...
    it('should hide items that overflow the nav width', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav" style="display: flex; width: 250px;" data-cx-toggle="nav-overflow">',
      ...
      const hiddenItems = navEl.querySelectorAll('.nav-item[data-cx-nav-overflow="true"]')
    ...
    it('should hide overflow toggle when no items overflow', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav" style="display: flex; width: 5000px;" data-cx-toggle="nav-overflow">',
    ...
    it('should preserve active state on cloned menu items', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav" style="display: flex; width: 150px;" data-cx-toggle="nav-overflow">',
        '  <li class="nav-item" style="flex: 0 0 100px; width: 100px;"><a class="nav-link" href="#">Link 1</a></li>',
      ...
      const originalActiveHidden = navEl.querySelector('.nav-item[data-cx-nav-overflow="true"] .nav-link.active')
    ...
    it('should preserve disabled state on cloned menu items', () => {
      ...
      const originalDisabledHidden = navEl.querySelector('.nav-item[data-cx-nav-overflow="true"] .nav-link.disabled')
    ...
    it('should fire overflow event with overflowCount and visibleCount', () => {
      ...
      navEl.addEventListener('overflow.cx.navoverflow', event => {
        eventFired = true
    ...
    it('should restore items when update causes no overflow', () => {
      ...
      const hiddenBefore = navEl.querySelectorAll('.nav-item[data-cx-nav-overflow="true"]')
      ...
      const hiddenAfter = navEl.querySelectorAll('.nav-item[data-cx-nav-overflow="true"]')
  ...
  describe('config', () => {
    ...
    it('should use a child element with [data-cx-overflow-icon] as the icon', () => {
      ...
      expect(navEl.querySelector('[data-cx-overflow-icon]')).toBeNull()
  ...
  describe('collapseBelow', () => {
    it('should collapse all items when nav width is below collapseBelow (number)', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav" style="display: flex; width: 400px;" data-cx-toggle="nav-overflow">',
        '  <li class="nav-item" style="flex: 0 0 50px; width: 50px;"><a class="nav-link" href="#">Link 1</a></li>',
        '  <li class="nav-item" style="flex: 0 0 50px; width: 50px;"><a class="nav-link" href="#">Link 2</a></li>',
